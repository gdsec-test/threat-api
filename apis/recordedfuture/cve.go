...
// CVEReportFields are the fields to submit to RF API to get a standard CVE report
...
func (m *TriageModule) EnrichCVE(ctx context.Context, cve string, fields []string, metadata bool) (*CVEReport, error) {
	...
	//Converting cve ToUpper as RF throws error if its in smaller case cve-2014-0160 to CVE-2014-0160
	URL := fmt.Sprintf("%s%v?%s", vulnerabilityEndpoint, strings.ToUpper(cve), values.Encode())
