...
func TestApiVoidMetaDataExtract(t *testing.T) {

	Convey("apiVoidMetaDataExtract", t, func() {
		...
		Convey("should extract domain metadata properly", func() {
			...
			expectedMetadata := []string{"IOC: gumblar.cn, RiskScore:{100}\n", "IOC: gumblar.cn, FullReportS3URL:\n", "IOC: gumblar.cn,Detections:3, Engines Count: 47, Detection Rate: 6%\n", "IOC: gumblar.cn, Server:{103.224.182.249 lb-182-249.above.com OC Oceania AU Australia Victoria Beaumaris -37.982200622558594 145.0389404296875 Trellian Pty. Limited AS133618}\n", "IOC: gumblar.cn, Category:{false false false false}\n", "IOC: gumblar.cn, SecurityChecks:{low false false false false false false false false false false false false false false false false false false false false true false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false   false false false}\n"}
			actualMetadata := apiVoidMetaDataExtract(reports, triage.DomainType)
			So(actualMetadata, ShouldResemble, expectedMetadata)
		})

		Convey("should extract IP metadata properly", func() {
			APIvoidReportData := &APIvoidReport{}
			responseReportString := `{
				"data": {
						"report": {
			...
			expectedMetadata := []string{"IOC: 80.82.77.139, RiskScore:{100}\n", "IOC: 80.82.77.139, FullReportS3URL:\n", "IOC: 80.82.77.139,Detections:30, Engines Count: 98, Detection Rate: 31%\n", "IOC: 80.82.77.139, Information:{dojo.census.shodan.io EU Europe NL Netherlands EUR 31 Zuid-Holland The Hague 52.0766716003418 4.298610210418701 Incrediserve Ltd AS202425}\n", "IOC: 80.82.77.139, Anonymity:{false false false true false}\n"}
			actualMetadata := apiVoidMetaDataExtract(reports, triage.IPType)
			So(actualMetadata, ShouldResemble, expectedMetadata)
		})

		Convey("should extract URL metadata properly", func() {
			APIvoidReportData := &APIvoidReport{}
			responseReportString := `{
				"data": {
						"report": {
			...
			expectedMetadata := []string{"IOC: https://www.amazon.com, RiskScore:{0}\n", "IOC: https://www.amazon.com, FullReportS3URL:\n", "IOC: https://www.amazon.com,Detections:0\n", "IOC: https://www.amazon.com,FileType:{  HTML}\n", "IOC: https://www.amazon.com,GeoLocation:{[US]}\n", "IOC: https://www.amazon.com,HTMLForms:{3 8 false false false false}\n", "IOC: https://www.amazon.com,Redirection:{false false <nil>}\n", "IOC: https://www.amazon.com,ResponseHeaders:{200 HTTP/2 200 Server text/html;charset=UTF-8 PTC6HM19MX9RB6CB7D8G 86400 1; no-cache gzip en-US nosniff ect,rtt,downlink -1 IE=edge no-cache max-age=47474747; includeSubDomains; preload SAMEORIGIN interest-cohort=() Sun, 26 Sep 2021 22:39:50 GMT Accept-Encoding session-id=132-2632732-1637209; Domain=.amazon.com; Expires=Mon, 26-Sep-2022 22:39:50 GMT; Path=/; Secure session-id-time=2082787201l; Domain=.amazon.com; Expires=Mon, 26-Sep-2022 22:39:50 GMT; Path=/; Secure i18n-prefs=USD; Domain=.amazon.com; Expires=Mon, 26-Sep-2022 22:39:50 GMT; Path=/ lc-main=en_US; Domain=.amazon.com; Expires=Mon, 26-Sep-2022 22:39:50 GMT; Path=/ skin=noskin; path=/; domain=.amazon.com}\n", "IOC: https://www.amazon.com, SecurityChecks:{ false false false false false false false false false false false false false false false false false true false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false false   false false true}\n", "IOC: https://www.amazon.com, ServerDetails:{23.46.201.47 a23-46-201-47.deploy.static.akamaitechnologies.com NA North America US United States of America Georgia Atlanta 33.749000549316406 -84.38797760009766 Akamai Technologies Inc. AS16625}\n", "IOC: https://www.amazon.com, SiteCategory:{false false false false false false}\n", "IOC: https://www.amazon.com, URLParts:{https www.amazon.com amazon.com <nil> <nil> <nil>}\n", "IOC: https://www.amazon.com, WebPage:{Amazon.com. Spend less. Smile more. Free shipping on millions of items. Get the best of Shopping and Entertainment with Prime. Enjoy low prices and great deals on the largest selection of everyday essentials and other products, including fashion, home, beauty, electronics, Alexa Devices, sporting goods, toys, automotive, pets, baby, books, video games, musical instruments, office supplies, and more. Amazon, Amazon.com, Books, Online Shopping, Book Store, Magazine, Subscription, Music, CDs, DVDs, Videos, Electronics, Video Games, Computers, Cell Phones, Toys, Games, Apparel, Accessories, Shoes, Jewelry, Watches, Office Products, Sports & Outdoors, Sporting Goods, Baby Products, Health, Personal Care, Beauty, Home, Garden, Bed & Bath, Furniture, Tools, Hardware, Vacuums, Outdoor Living, Automotive Parts, Pet Supplies, Broadband, DSL}\n"}
			actualMetadata := apiVoidMetaDataExtract(reports, triage.URLType)
			So(actualMetadata, ShouldResemble, expectedMetadata)
		})
